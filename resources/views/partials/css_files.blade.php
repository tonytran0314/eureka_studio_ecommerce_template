...
<link rel="stylesheet" href="{{ secure_asset('css/general_configs.css') }}">
...
<link rel="stylesheet" href="{{ secure_asset('css/exploring.css') }}">
<link rel="stylesheet" href="{{ secure_asset('css/selection.css') }}">
